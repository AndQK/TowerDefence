...
```
cd existing_repo
git remote add origin https://version.aalto.fi/gitlab/skondra1/towerdefence.git
git branch -M main
...
- [ ] [Set up project integrations](https://version.aalto.fi/gitlab/skondra1/towerdefence/-/settings/integrations)
