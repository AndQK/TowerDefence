...
Level::Level(int initial_money, int initial_lives, int enemies_killed,
...
int Level::initial_money() const {
    return initial_money_;
}

int Level::initial_lives() const {
    return initial_lives_;
}

int Level::enemies_killed() const {
...
bool Level::done() {
    return enemies_killed_ == enemy_.size();
}